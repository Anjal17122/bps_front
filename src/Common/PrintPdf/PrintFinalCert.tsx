...
import PDF3Certificate from "./PDF3Certificate";

const PrintFinalCert = ({ pid }: { pid: number }) => {
  ...
  return (
    <>
      <Tooltip title="Download Building Completion Certificate">
        <Button
          loading={loading}
          type="primary"
      ...
      >
        <Spin spinning={loading}>
          <div ref={componentRef} className="PrintPlinthCert">
            {plinthCert ? <PDF3Certificate /> : null}
          </div>
        </Spin>
      </Modal>
      {/* </Spin> */}
