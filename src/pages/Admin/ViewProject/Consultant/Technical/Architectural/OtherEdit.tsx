...
//   ProvisionOfFireEsc,
//   ProvisionOfSepEntrance,
// } from "../../../../Common/AllOptions/AllOptionsArchitectural";
          ...
          <tbody>
            <tr>
              ...
              <td className="width80">
                ...
                >
                  <Cascader options={ProvisionOfFireEsc} disabled={true} />
                </Form.Item>
              </td>
              <td className="width80">
                <Form.Item
            ...
            <tr>
              ...
              <td className="width80">
                ...
                >
                  <Cascader options={ProvisionOfSepEntrance} disabled={true} />
                </Form.Item>
              </td>
              <td className="width80">
                <Form.Item
