      ...
      >
        ...
        >
          ...
          <Text>
            ...
            {underline(
              ConvertToNepali(
                convertToFeet(parseFloat(pdfData?.buildingLength))
              )
            )}
            , &nbsp;चौडाई{" "}
            {underline(
              ConvertToNepali(convertToFeet(parseFloat(pdfData?.buildingWidth)))
            )}
            , &nbsp;कुल उचाई{" "}
            {underline(
              ConvertToNepali(
                convertToFeet(parseFloat(pdfData?.buildingHeight))
              )
            )}
