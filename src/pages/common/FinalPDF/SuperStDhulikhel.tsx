...
const SuperStDhulikhel = ({ data, pdfData, pid, mapdandaPid }: Props) => {
  Font.register({
    family: "Noto",
    src: Noto,
  });
  ...
  return (
    <Document>
      ...
      >
        ...
        >
          <Text> मिति : {ConvertToNepali(pdfData.superStructureDate)}</Text>
        </View>
        <View
          style={{
            width: "100%",
        ...
        >
          ...
          <Text>
            ...
            {underline("घर")} बनाउन पाउँ भन्‍ने नक्सा दरखास्त परेकोले
            प्राविधिकबाट निरिक्षण गर्दा तपसिलमा लेखिए बमोजिमको तपाईको नाउँमा
            बनाउँन {underline("घर")} को लागि यो नक्सा निम्न उल्लेखित शर्त बमोजिम
            नक्सा पास प्रमाण पत्र र स्वीकृत नक्सा प्रति समेत यसै साथमा दिने काम
            भएको छ । नक्सा पात्र भन्‍दा फेर बदल नहुने गरी तथा मापदण्डलाई आँच
            आउने गरी निर्माण कार्य गरेमा सम्पन्न प्रमाण पत्र दिन कार्यालय बाध्य
            हुने छैन ।
          </Text>
        </View>
        <View
...
export default SuperStDhulikhel;
