...
const AddBuildingReport = () => {
  ...
  const onSubmit = (val: BuildingReportPdfDataType) => {
    ...
    saveBuildingCompletionReport(fullData, messageApi).then((res) => {
      console.log(res);
      navigate(`/user/upload/Nirmsampanna/${pid}`);
    });
  };
    ...
    <div>
      ...
      <div>
        <div className="HeadBar">
          <div></div>
          <h1>
            <span className="title">Add Nirmansampanna Report</span>
          </h1>
          <div></div>
        </div>
...
export default AddBuildingReport;
