...
import { GetDrawingsSignPositionBody } from "../../Services/DigitalSignatureService";
...
const DigitalSignExtra = () => {
  ...
  useEffect(() => {
    ...
    // });
    setLatestPDF("C:\\Users\\Dell\\Documents\\digiimagestest\\nirmansamp.pdf");
    // GetUserId()
  ...
  const signPDF = ({
    ...
    setSubmitting(true);
    const mycoordinates = getCoordinates("a4", 1);
        ...
        <div className="ViewPdf">
          {latestPDF ? (
            <embed
              ...
              src={
                "http://localhost:5000/images/pdf/superstructure/1721973633445_nirmansamp.pdf"
              }
            />
          ) : null}
        </div>
...
export default DigitalSignExtra;
