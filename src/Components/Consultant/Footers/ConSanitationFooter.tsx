...
import { SanitationCommon } from "../../../pages/Admin/ViewProject/Consultant/Technical/Sanitation/ViewSanitationAd";
import { CustomMsgErr } from "../../Common/CustomMsg/CustomMsg";
...
const ConSanitationFooter = ({ pid }: Props) => {
  ...
  const onView = (data: any) => {
    setModalOpen(true);
    setProject(JSON.parse(data.underWaterTank));
    if (modalOpen) {
      return;
    }
    setModalOpen(true);
    ...
    <div className="comment">
      ...
      {project ? (
        <AllLogModal
          ...
          children={<SanitationCommon sanitation={project} />}
        />
      ) : null}
...
export default ConSanitationFooter;
