...
// import { ElectricalCommon } from "../ViewProject/Consultant/Technical/Electrical/Electrical";

interface Props {
  pid: string;
}

const AdElectricalFooter = ({ pid }: Props) => {
...
export default AdElectricalFooter;
